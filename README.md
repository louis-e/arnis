...
>***Important***: Arnis relies on [OpenStreetMap](https://www.openstreetmap.org) for building data. Any buildings missing or incomplete in OSM will not be generated.
