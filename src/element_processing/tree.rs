use crate::block_definitions::{
    ANDESITE_WALL, ANVIL, BEDROCK, BIRCH_LEAVES, BIRCH_LOG, BLACK_CONCRETE, BLACK_TERRACOTTA,
    BLACKSTONE, BLUE_CONCRETE, BLUE_TERRACOTTA, BOOKSHELF, BREWING_STAND, BRICK, BROWN_CONCRETE,
    BROWN_STAINED_GLASS, BROWN_TERRACOTTA, Block, CAULDRON, CHEST, COBBLESTONE_WALL,
    ...
    MAGENTA_CONCRETE, MUD_BRICKS, NETHER_BRICK, NETHERITE_BLOCK, NOTE_BLOCK, OAK_DOOR, OAK_FENCE,
    ...
    SPRUCE_LOG, STONE_BLOCK_SLAB, STONE_BRICK_SLAB, STONE_BRICK_WALL, STONE_BRICKS, TINTED_GLASS,
