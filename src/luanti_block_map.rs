...
fn to_mineclonia_node(block: Block, props: Option<&Value>) -> LuantiNode {
    let name = match block.id() {
        ...
        92 => "mcl_wool:white",
        93 => "mcl_ocean:tall_seagrass", // TALL_SEAGRASS_TOP
        94 => "mcl_flowers:dandelion",
        95 => "mcl_ocean:sea_pickle", // SEA_PICKLE
        ...
        218 => "mcl_redstone_lamps:lamp_on", // REDSTONE_LAMP (only placed lit)
        ...
        236 | 299 => return conv_trapdoor(props, "mcl_doors:trapdoor", "mcl_doors:trapdoor_open"),
        ...
        256 => "mesecons_walllever:wall_lever_off",    // LEVER
        258 => "mcl_minecarts:rail",
        259 => "mcl_wool:red",
        260 => "mcl_core:ladder",
        261 => "mcl_wool:yellow",
        274 => "mcl_signs:wall_sign",
        275 => "mcl_banners:hanging_banner_blue", // BLUE_WALL_BANNER
        277 => "mcl_banners:hanging_banner_black", // BLACK_WALL_BANNER
        278 => "mcl_banners:hanging_banner_red",  // RED_WALL_BANNER
        285 => "mcl_banners:hanging_banner_green", // GREEN_WALL_BANNER
        286 => "mcl_cauldrons:cauldron_3",        // WATER_CAULDRON (filled)
        289 => "mcl_wool:red_carpet",
        293 => "mcl_doors:wooden_door_b_1",
        301 => "mcl_core:cobweb",
        ...
        360 => "mcl_wool:orange",
        361 => "mcl_wool:blue",
        363 => "mcl_banners:hanging_banner_white", // WHITE_WALL_BANNER
        364 => "mcl_doors:spruce_door_b_1",
        365 => "mcl_doors:spruce_door_t_1",
        366 => "mcl_doors:wooden_door_b_1",
        _ => "mcl_core:stone",
    };
    LuantiNode { name, param2: 0 }
}
